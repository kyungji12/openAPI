...
public String goLogin(){
	return goXML("http://192.168.23.95:8090/190809xml/login.jsp",true);
}
...
<h1>성적조회</h1>
	<%
		//로그인 후 xml을 조회한다. 내부소스에 이미 세션을 유지하도록 설계되어있다.
		String ret=goLogin();
		ret=goXML("http://192.168.23.95:8090/190809xml/loginxml.jsp");
		try{			
			...
			//builder를 이용하여 XML파싱하여 Document객체 생성
